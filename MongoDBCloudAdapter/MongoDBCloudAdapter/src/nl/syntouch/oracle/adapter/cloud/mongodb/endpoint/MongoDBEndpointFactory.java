...
public class MongoDBEndpointFactory implements EndpointFactory {

    @Override
    public Endpoint createEndpoint(String string) throws CloudInvocationException {
        return new MongoDBEndpoint();
    }
}
